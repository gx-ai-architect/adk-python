...
4. Save all examples to .session_tmp/seed_data.jsonl using the available file writing tools;
5. Read .session_tmp/seed_data.jsonl to verify that the file is saved correctly. If not, go to step 6 to save again.
6. Show updated examples and ask if approved
...
- Save to JSONL format (newline-delimited JSON objectss)
...
Remember: You only handle State-2 (Seed Data Iteration).''',
